...
class TcgaDataLoader(BaseDataLoader):
    ...
    def load_data(self):
        ...
        cnv_path = Path.joinpath(pt.TCGA_DIR, "PC_CNV_threshold_20.csv")
        mirna_path = Path.joinpath(pt.TCGA_DIR, "PC_miRNA.csv")
        mrna_path = Path.joinpath(pt.TCGA_DIR, "PC_mRNA_threshold_7.csv")
        cli_path = Path.joinpath(pt.TCGA_DIR, "Pc_clinical_emb.csv")
