...
DATA_DIR = Path.joinpath(Path(__file__).absolute().parent.parent, 'data')
...
TCGA_DIR = Path('/home/armand/Desktop').joinpath('Pancancer_data_2023')
#TCGA_DIR = Path.joinpath('/home/armand/Desktop', 'Pancancer_data_2023')
